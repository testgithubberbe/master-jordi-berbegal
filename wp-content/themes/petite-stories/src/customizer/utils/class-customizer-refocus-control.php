...
?>
        <div class="superbthemes-customizer-refocus-button-wrapper">
            <p>
                <?php esc_html_e("Other customization sections are available for this element. Click the buttons below to switch to other customization sections.", "petite-stories"); ?>
            </p>
            <?php
