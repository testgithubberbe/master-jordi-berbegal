	...
	<?php if (has_post_thumbnail()) : ?>
		<div class="featured-img-box">
			<a href="<?php the_permalink() ?>" class="featured-thumbnail" rel="bookmark">
				<?php esc_html(the_post_thumbnail('petite-stories-noresize')); ?>
			</a>
		<?php else : ?>
			...
			<div class="content-wrapper">
					...
					if ('post' === get_post_type()) : ?>
						<div class="entry-meta">
							<div class="blog-data-wrapper">
								<span class="post-author-wrapper"><?php esc_html_e('By', 'petite-stories'); ?> <?php the_author(); ?> <?php esc_html_e('on', 'petite-stories'); ?></span>
				...
				<?php if (get_theme_mod('show_except_or_full') == '') : ?>
					<a class="read-story" href="<?php the_permalink() ?>">
						<?php esc_html_e('Continue reading', 'petite-stories'); ?>
					</a>
				<?php else : ?>
				<?php endif; ?>
			</div>
